...
const StockMain = () => {
  ...
  const buttons = [
    { name: "Stock Data", action: "unship", icon: <MdOutlinePending /> },
    { name: "Low stock", action: "booked", icon: <CiDeliveryTruck /> },
    { name: "Hidden Stock", action: "returned", icon: <GiReturnArrow /> },
